...
const harvest_1 = require("./services/harvest");
...
program
    ...
    try {
        ...
        const oauthConfig = {
            ...
            scope: 'all',
            tokenStoragePath: path_1.default.join(process.cwd(), '.tokens.json'),
        };
        ...
        // Initialize services
        const sourceHarvest = new harvest_1.HarvestService(oauthConfig, true);
        const destHarvest = new harvest_1.HarvestService(oauthConfig, false);
        ...
        const { date } = await inquirer_1.default.prompt([
            {
                type: 'input',
                name: 'date',
